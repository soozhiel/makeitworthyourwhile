const SITE_URL = 'https://makeitworthyourwhile.vercel.app';
...
async function sharePage() {
  if (navigator.share) { try { await navigator.share({ title: 'Make It Worth Your While — Sonic Remedy | Soozhee', text: 'Make It Worth Your While by Soozhee. Sonic Remedy : Audiosensory Resonance | No Regret.', url: SITE_URL }); return; } catch (e) {} }
